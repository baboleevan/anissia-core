...
interface AnimeHitHourRepository : JpaRepository<AnimeHitHour, AnimeHitHour.Key>,
    QuerydslPredicateExecutor<AnimeHitHour> {
    ...
    @Query(
        """
        SELECT
            new anissia.domain.anime.core.model.AnimeRankDto(a.animeNo, (SELECT b.subject FROM Anime b WHERE b.animeNo = a.animeNo), sum(a.hit))
        FROM AnimeHitHour a
